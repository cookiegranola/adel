...
#else
#	[ -d minetest ] && (cd minetest && git pull) || (git clone https://github.com/cookiegranola/Adel -b windows)
#	mv Adel minetest
#fi
cd minetest
...
#	[ -d minetest_game ] && (cd minetest_game && git pull) || (git clone --recursive https://github.com/cookiegranola/minetest_game)
#fi
cd ../..
...
mkdir _build
cd _build
cmake .. -DHOST_CC="gcc -m32" -DCROSS=i686-w64-mingw32- -DTARGET_SYS=Windows \
	-DRUN_IN_PLACE=0 \
	...
	\
	-DLUA_INCLUDE_DIR_NOT_USED=$libdir/luajit/include \
	-DLUA_LIBRARY_NOT_USED=$libdir/luajit/libluajit.a \
	\
...
cp ~/dev/kidscode/projects/Adel/minilua  ~/dev/kidscode/projects/Adel/minetest/_build/lib/lua
cp ~/dev/kidscode/projects/Adel/buildvm  ~/dev/kidscode/projects/Adel/minetest/_build/lib/lua
